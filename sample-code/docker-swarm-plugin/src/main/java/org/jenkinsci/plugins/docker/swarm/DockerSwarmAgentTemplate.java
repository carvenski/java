...
public class DockerSwarmAgentTemplate implements Describable<DockerSwarmAgentTemplate>, Serializable {
    ...
    // construct method for dockerSwarmTemplate
    public DockerSwarmAgentTemplate(
        final String label,
        final String image,
    ...
    public DockerSwarmAgentTemplate(final String image, final String hostBinds, final String hostNamedPipes, final String dnsIps,
                                    final String dnsSearchDomains, final String unixCommand, final String windowsCommand, final String user, final String workingDir, final String isolation,
