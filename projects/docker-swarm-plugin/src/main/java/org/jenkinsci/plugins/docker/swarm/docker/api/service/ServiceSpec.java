...
public class ServiceSpec extends ApiRequest {
    ...
    public ServiceSpec(String name, String Image, String[] Cmd, String[] Env, String Dir, String isolation, String User, String[] Hosts)
            throws IOException {
        super(HttpMethod.POST, "/services/create", CreateServiceResponse.class, ResponseType.CLASS);
        this.Name = name;
        this.TaskTemplate = new TaskTemplate(Image, Cmd, Env, Dir, isolation, User, Hosts);
