...
public class DockerSwarmComputerLauncher extends JNLPLauncher {
    ...
    private void launch(final DockerSwarmComputer computer, final TaskListener listener) throws IOException {
        ...
        if (dockerSwarmAgentTemplate.isOsWindows()) {
            ...
            launchContainer(finalCommand.toArray(new String[0]), configuration, envVars, dockerSwarmAgentTemplate.getWorkingDir(),
                    dockerSwarmAgentTemplate.getIsolation(),dockerSwarmAgentTemplate.getUser(), dockerSwarmAgentTemplate, listener, computer,
            ...
            launchContainer(dockerSwarmAgentTemplate.getUnixCommandConfig(), configuration, envVars,
                    dockerSwarmAgentTemplate.getWorkingDir(),dockerSwarmAgentTemplate.getIsolation(), dockerSwarmAgentTemplate.getUser(),
    ...
    public void launchContainer(String[] commands, DockerSwarmCloud configuration, String[] envVars, String dir, String isolation,
        ...
        ServiceSpec crReq = createCreateServiceRequest(commands, configuration, envVars, dir, isolation, user,
    ...
    private ServiceSpec createCreateServiceRequest(String[] commands, DockerSwarmCloud configuration, String[] envVars,
            String dir, String isolation, String user, DockerSwarmAgentTemplate dockerSwarmAgentTemplate, DockerSwarmComputer computer,
